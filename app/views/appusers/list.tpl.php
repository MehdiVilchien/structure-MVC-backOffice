...
<table class="table table-hover mt-4">
    ...
    <?php foreach($users as $currentUser): ?>
        <tr>
            ...
            <td class="text-right">
                <a href="<?= $router->generate('appusers-edit', ['id' => $currentUser->getId()]) ?>" class="btn btn-sm btn-warning">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?= $router->generate('appusers-delete', 
                            ['id' => $currentUser->getId()])?>">Oui, je veux supprimer</a>
