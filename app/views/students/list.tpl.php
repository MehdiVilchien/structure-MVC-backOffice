        ...
        <table class="table table-hover mt-4">
            ...
            <?php foreach($students as $currentStudent): ?>
                <tr>
                    ...
                    <td class="text-right">
                        <a href="<?= $router->generate('students-edit', ['id' => $currentStudent->getId()]) ?>" class="btn btn-sm btn-warning">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item"
                                    href="<?= $router->generate('students-delete', 
                            ['id' => $currentStudent->getId()])?>">Oui, je veux
                                    supprimer</a>
